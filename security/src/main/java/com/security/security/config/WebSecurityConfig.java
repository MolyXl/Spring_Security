...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                .antMatchers("/test/del/**").hasRole("administrators")
                .antMatchers("/test/update").hasAnyRole("administrators", "auditor")
                .antMatchers("/test/add").hasAnyRole("administrators", "operator")
                .antMatchers("/test/get/**", "/test/list").access("permitAll");
        /**
